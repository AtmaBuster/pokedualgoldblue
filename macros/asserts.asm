...
def_kanto_wildmons: MACRO
;\1: map id
REDEF CURRENT_KANTO_WILDMONS_MAP EQUS "\1"
REDEF CURRENT_KANTO_WILDMONS_LABEL EQUS "._def_kanto_wildmons_\1"
{CURRENT_KANTO_WILDMONS_LABEL}:
	map_id \1
ENDM
	
end_kanto_wildmons: MACRO
	REDEF CURRENT_KANTO_WILDMONS_LENGTH EQU @ - {CURRENT_KANTO_WILDMONS_LABEL}
	assert KANTO_WILDDATA_LENGTH == CURRENT_KANTO_WILDMONS_LENGTH, \
		"def_kanto_wildmons {CURRENT_KANTO_WILDMONS_MAP}: expected {d:KANTO_WILDDATA_LENGTH} bytes, got {d:CURRENT_KANTO_WILDMONS_LENGTH} bytes"
ENDM
