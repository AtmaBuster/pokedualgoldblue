Music_RBYMeetRival:
	musicheader 3, 1, Music_MeetRival_Ch1
	musicheader 1, 2, Music_MeetRival_Ch2
	musicheader 1, 3, Music_MeetRival_Ch3

Music_RBYFarewellRival:
	musicheader 3, 1, Music_FarewellRival_Ch1
	musicheader 1, 2, Music_FarewellRival_Ch2
	musicheader 1, 3, Music_FarewellRival_Ch3
