Music_RBYCinnabarMansion:
	musicheader 4, 1, Music_CinnabarMansion_Ch1
	musicheader 1, 2, Music_CinnabarMansion_Ch2
	musicheader 1, 3, Music_CinnabarMansion_Ch3
	musicheader 1, 4, Music_CinnabarMansion_Ch4
