Music_RBYMeetFemaleTrainer:
	musicheader 3, 1, Music_MeetFemaleTrainer_Ch1
	musicheader 1, 2, Music_MeetFemaleTrainer_Ch2
	musicheader 1, 3, Music_MeetFemaleTrainer_Ch3
