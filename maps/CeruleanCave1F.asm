...
CeruleanCave1F_MapEvents:
	...
	def_object_events
	object_event  7, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanCave1F_FullRestoreScript, EVENT_CERULEAN_CAVE_1F_FULL_RESTORE
	object_event 19,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanCave1F_MaxElixerScript, EVENT_CERULEAN_CAVE_1F_MAX_ELIXER
	object_event  5,  0, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanCave1F_NuggetScript, EVENT_CERULEAN_CAVE_1F_NUGGET
