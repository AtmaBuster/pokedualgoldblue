...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/murkrow/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, DREAM_EATER, SKY_ATTACK, REST, THUNDER_WAVE, PSYWAVE, SUBSTITUTE, FLY
ENDC
	; end
