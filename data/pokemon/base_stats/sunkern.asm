...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/sunkern/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, TAKE_DOWN, DOUBLE_EDGE, RAGE, MEGA_DRAIN, SOLARBEAM, MIMIC, DOUBLE_TEAM, BIDE, REST, SUBSTITUTE, CUT, FLASH
ENDC
	; end
