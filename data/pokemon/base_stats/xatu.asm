...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/xatu/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MEGA_DRAIN, SOLARBEAM, PSYCHIC_M, TELEPORT, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, DREAM_EATER, SKY_ATTACK, REST, THUNDER_WAVE, PSYWAVE, SUBSTITUTE, FLY, FLASH
ENDC
	; end
