...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MEGA_DRAIN, SOLARBEAM, PSYCHIC, TELEPORT, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, METRONOME, SWIFT, DREAM_EATER, REST, PSYWAVE, SUBSTITUTE, CUT, FLASH
ENDC
	; end
