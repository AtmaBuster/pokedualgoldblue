...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/phanpy/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, WATER_GUN, COUNTER, RAGE, EARTHQUAKE, FISSURE, MIMIC, DOUBLE_TEAM, BIDE, SKULL_BASH, REST, SUBSTITUTE, STRENGTH, HEADBUTT, ROCK_SMASH
ENDC
	; end
