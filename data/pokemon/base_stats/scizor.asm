...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/scizor/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, SWORDS_DANCE, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, COUNTER, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, SKULL_BASH, REST, SUBSTITUTE, CUT, STRENGTH, HEADBUTT, ROCK_SMASH
ENDC
	; end
