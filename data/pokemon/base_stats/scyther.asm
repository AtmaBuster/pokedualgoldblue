...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/scyther/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, SKULL_BASH, REST, SUBSTITUTE, CUT, HEADBUTT, ROCK_SMASH
ENDC
	; end
