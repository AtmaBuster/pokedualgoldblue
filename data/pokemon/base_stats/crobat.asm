...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/crobat/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MEGA_DRAIN, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, REST, SUBSTITUTE, FLY
ENDC
	; end
