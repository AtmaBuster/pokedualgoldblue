...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/tangela/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MEGA_DRAIN, SOLARBEAM, MIMIC, DOUBLE_TEAM, BIDE, SKULL_BASH, REST, SUBSTITUTE, CUT, HEADBUTT
ENDC
	; end
