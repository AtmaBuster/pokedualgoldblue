...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/rapidash/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm TOXIC, HORN_DRILL, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, FIRE_BLAST, SWIFT, SKULL_BASH, REST, SUBSTITUTE, HEADBUTT
ENDC
	; end
