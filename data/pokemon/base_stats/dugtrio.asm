...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/dugtrio/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, EARTHQUAKE, FISSURE, DIG, MIMIC, DOUBLE_TEAM, BIDE, REST, ROCK_SLIDE, SUBSTITUTE, ROCK_SMASH
ENDC
	; end
