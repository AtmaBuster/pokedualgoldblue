...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, RAGE, SOLARBEAM, THUNDERBOLT, THUNDER, EARTHQUAKE, PSYCHIC_M, TELEPORT, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, SKULL_BASH, DREAM_EATER, REST, THUNDER_WAVE, PSYWAVE, SUBSTITUTE, STRENGTH
ENDC
	; end
