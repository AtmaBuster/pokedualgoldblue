...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/skarmory/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, COUNTER, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, SKY_ATTACK, REST, ROCK_SLIDE, SUBSTITUTE, CUT, FLY
ENDC
	; end
