...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/farfetch_d/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, SWORDS_DANCE, WHIRLWIND, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, RAGE, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, SKULL_BASH, REST, SUBSTITUTE, CUT, FLY, HEADBUTT
ENDC
	; end
