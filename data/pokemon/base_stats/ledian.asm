...
ELIF DEF(_BLUE)
	tmhm MEGA_PUNCH, SWORDS_DANCE, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, SUBMISSION, RAGE, MEGA_DRAIN, SOLARBEAM, DIG, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, REST, SUBSTITUTE, FLASH, HEADBUTT
ENDC
	; end
