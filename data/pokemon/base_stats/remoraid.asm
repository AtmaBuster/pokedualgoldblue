...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/remoraid/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm TOXIC, TAKE_DOWN, DOUBLE_EDGE, BUBBLEBEAM, WATER_GUN, ICE_BEAM, HYPER_BEAM, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, REST, THUNDER_WAVE, SUBSTITUTE, SURF
ENDC
	; end
