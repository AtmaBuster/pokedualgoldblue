...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/noctowl/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, DREAM_EATER, SKY_ATTACK, REST, PSYWAVE, SUBSTITUTE, FLY, FLASH
ENDC
	; end
