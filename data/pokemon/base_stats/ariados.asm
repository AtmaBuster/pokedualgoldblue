...
ELIF DEF(_BLUE)
	tmhm TOXIC, HORN_DRILL, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, RAGE, MEGA_DRAIN, SOLARBEAM, DIG, PSYCHIC, MIMIC, DOUBLE_TEAM, BIDE, REST, PSYWAVE, SUBSTITUTE, FLASH
ENDC
	; end
