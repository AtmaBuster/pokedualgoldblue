...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/mantine/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm RAZOR_WIND, WHIRLWIND, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, BUBBLEBEAM, WATER_GUN, ICE_BEAM, BLIZZARD, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, REST, SUBSTITUTE, SURF, HEADBUTT
ENDC
	; end
