...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/umbreon/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, PAY_DAY, RAGE, PSYCHIC_M, TELEPORT, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, SKULL_BASH, DREAM_EATER, REST, PSYWAVE, SUBSTITUTE, CUT, FLASH, HEADBUTT
ENDC
	; end
