...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/bulbasaur/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, RAGE, MEGA_DRAIN, SOLARBEAM, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, REST, SUBSTITUTE, CUT, HEADBUTT
ENDC
	; end
