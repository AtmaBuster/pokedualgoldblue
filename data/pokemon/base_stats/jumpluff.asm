...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/jumpluff/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, WHIRLWIND, TOXIC, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, PAY_DAY, RAGE, MEGA_DRAIN, SOLARBEAM, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, REST, SUBSTITUTE, FLASH, HEADBUTT
ENDC
	; end
