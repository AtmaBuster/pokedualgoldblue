...
ELIF DEF(_BLUE)
	tmhm MEGA_PUNCH, MEGA_KICK, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, WATER_GUN, SUBMISSION, COUNTER, SEISMIC_TOSS, RAGE, THUNDERBOLT, THUNDER, MIMIC, DOUBLE_TEAM, BIDE, METRONOME, SWIFT, SKULL_BASH, DREAM_EATER, REST, THUNDER_WAVE, SUBSTITUTE, CUT, STRENGTH, HEADBUTT, ROCK_SMASH
ENDC
	; end
