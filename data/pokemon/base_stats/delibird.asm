...
ELIF DEF(_BLUE)
	tmhm MEGA_PUNCH, RAZOR_WIND, WHIRLWIND, MEGA_KICK, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, ICE_BEAM, BLIZZARD, PAY_DAY, COUNTER, SEISMIC_TOSS, RAGE, MIMIC, DOUBLE_TEAM, BIDE, SWIFT, SKY_ATTACK, REST, SUBSTITUTE, FLY
ENDC
	; end
