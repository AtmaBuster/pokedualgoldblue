...
ELIF DEF(_BLUE)
	INCBIN "gfx/pokemon/ledyba/front_blue.dimensions"
ENDC
...
ELIF DEF(_BLUE)
	tmhm MEGA_PUNCH, SWORDS_DANCE, TOXIC, TAKE_DOWN, DOUBLE_EDGE, RAGE, MEGA_DRAIN, SOLARBEAM, DIG, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, SWIFT, REST, SUBSTITUTE, FLASH, HEADBUTT
ENDC
	; end
