...
ELIF DEF(_BLUE)
	tmhm SWORDS_DANCE, TOXIC, BODY_SLAM, TAKE_DOWN, DOUBLE_EDGE, HYPER_BEAM, COUNTER, RAGE, MEGA_DRAIN, SOLARBEAM, EARTHQUAKE, FISSURE, MIMIC, DOUBLE_TEAM, REFLECT, BIDE, REST, SUBSTITUTE, CUT, STRENGTH, FLASH
ENDC
	; end
