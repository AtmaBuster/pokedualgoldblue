	...
	tilecoll WALL, WALL, MART_SHELF, MART_SHELF ; 0a
	...
	tilecoll WALL, COUNTER, COUNTER, FLOOR ; 10
	...
	tilecoll MART_SHELF, MART_SHELF, FLOOR, FLOOR ; 1e
	...
	tilecoll COUNTER, WALL, FLOOR, COUNTER ; 27
