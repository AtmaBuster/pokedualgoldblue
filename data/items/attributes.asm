...
; TOWN_MAP
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; BICYCLE
	item_attribute 0, HELD_ESCAPE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; MOON_STONE
...
; COIN_CASE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, KEY_ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; ITEMFINDER
	item_attribute 0, HELD_FLINCH, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; POKE_FLUTE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXP_SHARE
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; OLD_ROD
	item_attribute 0, HELD_CATCH_CHANCE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; GOOD_ROD
	item_attribute 0, HELD_CATCH_CHANCE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; SILVER_LEAF
...
; S_S_TICKET
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTERY_EGG
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; OAKS_PARCEL
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILVER_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; ITEM_87
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SILPH_SCOPE
	item_attribute 0, HELD_CRITICAL_UP, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LIFT_KEY
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; TM01
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM02
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM03
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM04
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ITEM_C3
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TM05
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM06
	item_attribute 3000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM07
	item_attribute 2000, HELD_NONE, 0, CANT_SELECT | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; HM01
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HM02
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; HM03
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS | CANT_GIVE, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
