...
/*
	map AgathasRoom, TILESET_CEMETERY, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_POKEMON_TOWER,
	map BikeShop, TILESET_CLUB, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_CITIES2,
	map BillsHouse, TILESET_INTERIOR, INDOOR, LANDMARK_SEA_COTTAGE, MUSIC_RBY_CITIES2,
	map BluesHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_RBY_PALLET_TOWN,
	map BrunosRoomKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_DUNGEON1,
	map CeladonChiefHouse, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonDiner, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonGym, TILESET_GYM, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_GYM,
	map CeladonHotel, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMansion1F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMansion2F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMansion3F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMansionRoof, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMansionRoofHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map CeladonMart1F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMart2F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMart3F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMart4F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMart5F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMartElevator, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonMartRoof, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeladonPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_POKECENTER,
	map CeruleanBadgeHouse, TILESET_SHIP, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_CITIES1,
	map CeruleanCave1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1,
	map CeruleanCave2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1,
	map CeruleanCaveB1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1,
	map CeruleanGym, TILESET_GYM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_GYM,
	map CeruleanMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_POKECENTER,
	map CeruleanPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_POKECENTER,
	map CeruleanTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_CITIES2,
	map CeruleanTrashedHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_RBY_CITIES2,
	map ChampionsRoom, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_INDIGO_PLATEAU,
	map CinnabarGym, TILESET_FACILITY_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_GYM,
	map CinnabarLab, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_CINNABAR,
	map CinnabarLabFossilRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_CINNABAR,
	map CinnabarLabMetronomeRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_CINNABAR,
	map CinnabarLabTradeRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_CINNABAR,
	map CinnabarMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_POKECENTER,
	map CinnabarPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_RBY_POKECENTER,
	map ColosseumKanto, TILESET_CLUB, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CELADON,
	map CopycatsHouse1F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES1,
	map CopycatsHouse2F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES1,
	map DayCareKanto, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_5, MUSIC_RBY_CITIES1,
	map DiglettsCave, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2,
	map DiglettsCaveRoute2, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2,
	map DiglettsCaveRoute11, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2,
	map FightingDojo, TILESET_GYM, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES1,
	map FuchsiaBillsGrandpasHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_CITIES2,
	map FuchsiaGoodRodHouse, TILESET_SHIP, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_CITIES2,
	map FuchsiaGym, TILESET_GYM, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_GYM,
	map FuchsiaMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_POKECENTER,
	map FuchsiaMeetingRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_CITIES2,
	map FuchsiaPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_POKECENTER,
	map GameCorner, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_GAME_CORNER,
	map GameCornerPrizeRoom, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_RBY_CELADON,
	map HallOfFameKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_PALLET_TOWN,
	map IndigoPlateauLobby, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_INDIGO_PLATEAU,
	map LancesRoomKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_INDIGO_PLATEAU,
	map LavenderCuboneHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RBY_LAVENDER,
	map LavenderMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RBY_POKECENTER,
	map LavenderPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RBY_POKECENTER,
	map LoreleisRoom, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_RBY_GYM,
	map MrFujisHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_RBY_LAVENDER,
	map MrPsychicsHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES1,
	map MtMoon1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3,
	map MtMoonB1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3,
	map MtMoonB2F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3,
	map MtMoonPokecenter, TILESET_POKECENTER_KANTO, INDOOR,  LANDMARK_ROUTE_4, MUSIC_RBY_POKECENTER,
	map Museum1F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_CITIES1,
	map Museum2F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_CITIES1,
	map NameRatersHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES2,
	map OaksLab, TILESET_GYM, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_RBY_OAKS_LAB,
	map PewterGym, TILESET_GYM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_GYM,
	map PewterMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_POKECENTER,
	map PewterNidoranHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_CITIES1,
	map PewterPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_POKECENTER,
	map PewterSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_RBY_CITIES1,
	map PokemonFanClub, TILESET_INTERIOR, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_VERMILION,
	map PokemonMansion1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION,
	map PokemonMansion2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION,
	map PokemonMansion3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION,
	map PokemonMansionB1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION,
	map PokemonTower1F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower2F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower3F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower4F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower5F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower6F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PokemonTower7F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER, MUSIC_RBY_POKEMON_TOWER,
	map PowerPlant, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_RBY_DUNGEON1,
	map RedsHouse1F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_RBY_PALLET_TOWN,
	map RedsHouse2F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_RBY_PALLET_TOWN,
	map RocketHideoutB1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ, MUSIC_RBY_DUNGEON1,
	map RocketHideoutB2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ, MUSIC_RBY_DUNGEON1,
	map RocketHideoutB3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ, MUSIC_RBY_DUNGEON1,
	map RocketHideoutB4F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ, MUSIC_RBY_DUNGEON1,
	map RocketHideoutElevator, TILESET_LOBBY, DUNGEON, LANDMARK_ROCKET_HQ, MUSIC_RBY_DUNGEON1,
	map RockTunnel1F, TILESET_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_RBY_DUNGEON3,
	map RockTunnelB1F, TILESET_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_RBY_DUNGEON3,
	map RockTunnelPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ROUTE_10, MUSIC_RBY_POKECENTER,
	map Route2Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_RBY_CITIES1,
	map Route2TradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_2, MUSIC_RBY_CITIES1,
	map Route5Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_RBY_CITIES1,
	map Route6Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_6, MUSIC_RBY_CITIES1,
	map Route7Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_7, MUSIC_RBY_CITIES1,
	map Route8Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_8, MUSIC_RBY_CITIES1,
	map Route11Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_11, MUSIC_RBY_VERMILION,
	map Route11Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_VERMILION,
	map Route12Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_12, MUSIC_RBY_CITIES1,
	map Route12Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CITIES1,
	map Route12SuperRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_12, MUSIC_RBY_CELADON,
	map Route15Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_15, MUSIC_RBY_CITIES1,
	map Route15Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CITIES1,
	map Route16FlyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_16, MUSIC_RBY_CELADON,
	map Route16Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_16, MUSIC_RBY_CITIES1,
	map Route16Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CITIES1,
	map Route18Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_18, MUSIC_RBY_CITIES1,
	map Route18Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CITIES1,
	map Route22Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_22, MUSIC_RBY_DUNGEON2,
	map SafariZoneCenter, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneCenterRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneEast, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneEastRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneGate, TILESET_MUSEUM, GATE, LANDMARK_SAFARI_ZONE, MUSIC_RBY_CITIES2,
	map SafariZoneNorth, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneNorthRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneSecretHouse, TILESET_LAB_KANTO, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneWest, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SafariZoneWestRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE, MUSIC_RBY_SAFARI_ZONE,
	map SaffronGym, TILESET_FACILITY_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_GYM,
	map SaffronMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_POKECENTER,
	map SaffronPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_CITIES1,
	map SaffronPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_RBY_POKECENTER,
	map SeafoamIslands1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2,
	map SeafoamIslandsB1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2,
	map SeafoamIslandsB2F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2,
	map SeafoamIslandsB3F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2,
	map SeafoamIslandsB4F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2,
	map SilphCo1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo4F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo5F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo6F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo7F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo8F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo9F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo10F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCo11F, TILESET_INTERIOR, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SilphCoElevator, TILESET_LOBBY, DUNGEON, LANDMARK_SILPH_CO, MUSIC_RBY_SILPH_CO,
	map SSAnne1F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnne1FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnne2F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnne2FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnne3F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnneB1F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnneB1FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnneBow, TILESET_SHIP, SHIP, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnneCaptainsRoom, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map SSAnneKitchen, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE, MUSIC_RBY_SS_ANNE,
	map TradeCenterKanto, TILESET_CLUB, INDOOR, LANDMARK_SPECIAL, MUSIC_RBY_CELADON,
	map UndergroundPathNorthSouth, TILESET_TUNNEL, DUNGEON, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1,
	map UndergroundPathRoute5, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_RBY_CITIES1,
	map UndergroundPathRoute6, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_6, MUSIC_RBY_CITIES1,
	map UndergroundPathRoute7, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_7, MUSIC_RBY_CITIES1,
	map UndergroundPathRoute8, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_8, MUSIC_RBY_CITIES1,
	map UndergroundPathWestEast, TILESET_TUNNEL, INDOOR, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1,
	map VermilionDock, TILESET_SHIP_PORT, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_SS_ANNE,
	map VermilionGym, TILESET_GYM, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_GYM,
	map VermilionMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_POKECENTER,
	map VermilionOldRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_CITIES2,
	map VermilionPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_VERMILION,
	map VermilionPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_POKECENTER,
	map VermilionTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_RBY_VERMILION,
	map VictoryRoad1F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3,
	map VictoryRoad2F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3,
	map VictoryRoad3F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3,
	map ViridianForest, TILESET_SAFARI, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_RBY_DUNGEON2,
	map ViridianForestNorthGate, TILESET_MUSEUM, GATE, LANDMARK_VIRIDIAN_FOREST, MUSIC_RBY_CITIES1,
	map ViridianForestSouthGate, TILESET_MUSEUM, GATE, LANDMARK_VIRIDIAN_FOREST, MUSIC_RBY_CITIES1,
	map ViridianGym, TILESET_GYM, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_RBY_GYM,
	map ViridianMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_RBY_POKECENTER,
	map ViridianNicknameHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_RBY_CITIES1,
	map ViridianPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_RBY_POKECENTER,
	map ViridianSchoolHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_RBY_CITIES1,
	map WardensHouse, TILESET_LAB_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_RBY_CITIES2,
*/
