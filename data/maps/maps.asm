...
/*
	...
	map UndergroundPathNorthSouth, TILESET_TUNNEL, DUNGEON, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map UndergroundPathWestEast, TILESET_TUNNEL, INDOOR, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
