...
/*
	map AgathasRoom, TILESET_CEMETERY, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map BikeShop, TILESET_CLUB, INDOOR, LANDMARK_CERULEAN_CITY,
	map BillsHouse, TILESET_INTERIOR, INDOOR, LANDMARK_SEA_COTTAGE,
	map BluesHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PALLET_TOWN,
	map BrunosRoomKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map CeladonChiefHouse, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonDiner, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonGym, TILESET_GYM, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonHotel, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMansion1F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMansion2F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMansion3F, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMansionRoof, TILESET_MANSION, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMansionRoofHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMart1F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMart2F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMart3F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMart4F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMart5F, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMartElevator, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonMartRoof, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map CeladonPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CELADON_CITY,
	map CeruleanBadgeHouse, TILESET_SHIP, INDOOR, LANDMARK_CERULEAN_CITY,
	map CeruleanCave1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE,
	map CeruleanCave2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE,
	map CeruleanCaveB1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE,
	map CeruleanGym, TILESET_GYM, INDOOR, LANDMARK_CERULEAN_CITY,
	map CeruleanMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY,
	map CeruleanPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CERULEAN_CITY,
	map CeruleanTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY,
	map CeruleanTrashedHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_CERULEAN_CITY,
	map ChampionsRoom, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map CinnabarGym, TILESET_FACILITY_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarLab, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarLabFossilRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarLabMetronomeRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarLabTradeRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map CinnabarPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_CINNABAR_ISLAND,
	map ColosseumKanto, TILESET_CLUB, INDOOR, LANDMARK_SPECIAL,
	map CopycatsHouse1F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY,
	map CopycatsHouse2F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY,
	map DayCareKanto, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_5,
	map DiglettsCave, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE,
	map DiglettsCaveRoute2, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE,
	map DiglettsCaveRoute11, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE,
	map FightingDojo, TILESET_GYM, INDOOR, LANDMARK_SAFFRON_CITY,
	map FuchsiaBillsGrandpasHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY,
	map FuchsiaGoodRodHouse, TILESET_SHIP, INDOOR, LANDMARK_FUCHSIA_CITY,
	map FuchsiaGym, TILESET_GYM, INDOOR, LANDMARK_FUCHSIA_CITY,
	map FuchsiaMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY,
	map FuchsiaMeetingRoom, TILESET_LAB_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY,
	map FuchsiaPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY,
	map GameCorner, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map GameCornerPrizeRoom, TILESET_LOBBY, INDOOR, LANDMARK_CELADON_CITY,
	map HallOfFameKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map IndigoPlateauLobby, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map LancesRoomKanto, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map LavenderCuboneHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN,
	map LavenderMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN,
	map LavenderPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN,
	map LoreleisRoom, TILESET_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU,
	map MrFujisHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_LAVENDER_TOWN,
	map MrPsychicsHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map MtMoon1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON,
	map MtMoonB1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON,
	map MtMoonB2F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON,
	map MtMoonPokecenter, TILESET_POKECENTER_KANTO, INDOOR,  LANDMARK_ROUTE_4,
	map Museum1F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY,
	map Museum2F, TILESET_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY,
	map NameRatersHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map OaksLab, TILESET_GYM, INDOOR, LANDMARK_PALLET_TOWN,
	map PewterGym, TILESET_GYM, INDOOR, LANDMARK_PEWTER_CITY,
	map PewterMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY,
	map PewterNidoranHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY,
	map PewterPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_PEWTER_CITY,
	map PewterSpeechHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_PEWTER_CITY,
	map PokemonFanClub, TILESET_INTERIOR, INDOOR, LANDMARK_VERMILION_CITY,
	map PokemonMansion1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION,
	map PokemonMansion2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION,
	map PokemonMansion3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION,
	map PokemonMansionB1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION,
	map PokemonTower1F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower2F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower3F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower4F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower5F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower6F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PokemonTower7F, TILESET_CEMETERY, DUNGEON, LANDMARK_POKEMON_TOWER,
	map PowerPlant, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POWER_PLANT,
	map RedsHouse1F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN,
	map RedsHouse2F, TILESET_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN,
	map RocketHideoutB1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ,
	map RocketHideoutB2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ,
	map RocketHideoutB3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ,
	map RocketHideoutB4F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_ROCKET_HQ,
	map RocketHideoutElevator, TILESET_LOBBY, DUNGEON, LANDMARK_ROCKET_HQ,
	map RockTunnel1F, TILESET_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL,
	map RockTunnelB1F, TILESET_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL,
	map RockTunnelPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_ROUTE_10,
	map Route2Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2,
	map Route2TradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_2,
	map Route5Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5,
	map Route6Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_6,
	map Route7Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_7,
	map Route8Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_8,
	map Route11Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_11,
	map Route11Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL,
	map Route12Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_12,
	map Route12Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL,
	map Route12SuperRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_12,
	map Route15Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_15,
	map Route15Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL,
	map Route16FlyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_ROUTE_16,
	map Route16Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_16,
	map Route16Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL,
	map Route18Gate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_18,
	map Route18Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_SPECIAL,
	map Route22Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_22,
	map SafariZoneCenter, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE,
	map SafariZoneCenterRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE,
	map SafariZoneEast, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE,
	map SafariZoneEastRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE,
	map SafariZoneGate, TILESET_MUSEUM, GATE, LANDMARK_SAFARI_ZONE,
	map SafariZoneNorth, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE,
	map SafariZoneNorthRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE,
	map SafariZoneSecretHouse, TILESET_LAB_KANTO, INDOOR, LANDMARK_SAFARI_ZONE,
	map SafariZoneWest, TILESET_SAFARI, ROUTE, LANDMARK_SAFARI_ZONE,
	map SafariZoneWestRestHouse, TILESET_MUSEUM, INDOOR, LANDMARK_SAFARI_ZONE,
	map SaffronGym, TILESET_FACILITY_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map SaffronMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map SaffronPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map SaffronPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_SAFFRON_CITY,
	map SeafoamIslands1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS,
	map SeafoamIslandsB1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS,
	map SeafoamIslandsB2F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS,
	map SeafoamIslandsB3F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS,
	map SeafoamIslandsB4F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS,
	map SilphCo1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo4F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo5F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo6F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo7F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo8F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo9F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo10F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCo11F, TILESET_INTERIOR, DUNGEON, LANDMARK_SILPH_CO,
	map SilphCoElevator, TILESET_LOBBY, DUNGEON, LANDMARK_SILPH_CO,
	map SSAnne1F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnne1FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnne2F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnne2FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnne3F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnneB1F, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnneB1FRooms, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnneBow, TILESET_SHIP, SHIP, LANDMARK_S_S_ANNE,
	map SSAnneCaptainsRoom, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map SSAnneKitchen, TILESET_SHIP, INDOOR, LANDMARK_S_S_ANNE,
	map TradeCenterKanto, TILESET_CLUB, INDOOR, LANDMARK_SPECIAL,
	map UndergroundPathNorthSouth, TILESET_TUNNEL, DUNGEON, LANDMARK_UNDERGROUND_PATH,
	map UndergroundPathRoute5, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5,
	map UndergroundPathRoute6, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_6,
	map UndergroundPathRoute7, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_7,
	map UndergroundPathRoute8, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_8,
	map UndergroundPathWestEast, TILESET_TUNNEL, INDOOR, LANDMARK_UNDERGROUND_PATH,
	map VermilionDock, TILESET_SHIP_PORT, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionGym, TILESET_GYM, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionOldRodHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionPidgeyHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VERMILION_CITY,
	map VermilionTradeHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VERMILION_CITY,
	map VictoryRoad1F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD,
	map VictoryRoad2F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD,
	map VictoryRoad3F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD,
	map ViridianForest, TILESET_SAFARI, ROUTE, LANDMARK_VIRIDIAN_FOREST,
	map ViridianForestNorthGate, TILESET_MUSEUM, GATE, LANDMARK_VIRIDIAN_FOREST,
	map ViridianForestSouthGate, TILESET_MUSEUM, GATE, LANDMARK_VIRIDIAN_FOREST,
	map ViridianGym, TILESET_GYM, INDOOR, LANDMARK_VIRIDIAN_CITY,
	map ViridianMart, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY,
	map ViridianNicknameHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY,
	map ViridianPokecenter, TILESET_POKECENTER_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY,
	map ViridianSchoolHouse, TILESET_HOUSE_KANTO, INDOOR, LANDMARK_VIRIDIAN_CITY,
	map WardensHouse, TILESET_LAB_KANTO, INDOOR, LANDMARK_FUCHSIA_CITY,
*/
