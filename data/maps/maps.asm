...
MapGroup_Dungeons:
	...
	map ViridianForest, TILESET_SAFARI, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_RBY_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCave, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute2, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoon1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoonB1F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MtMoonB2F, TILESET_CAVERN, CAVE, LANDMARK_MT_MOON, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map UndergroundPathNorthSouth, TILESET_UNDERGROUND, DUNGEON, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPathWestEast, TILESET_UNDERGROUND, INDOOR, LANDMARK_UNDERGROUND_PATH, MUSIC_RBY_ROUTES1, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map PowerPlant, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POWER_PLANT, MUSIC_RBY_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map PokemonMansion1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonMansion2F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonMansion3F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map PokemonMansionB1F, TILESET_FACILITY_KANTO, DUNGEON, LANDMARK_POKEMON_MANSION, MUSIC_RBY_CINNABAR_MANSION, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslands1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandsB1F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandsB2F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandsB3F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamIslandsB4F, TILESET_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_RBY_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad1F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad2F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map VictoryRoad3F, TILESET_CAVERN, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_RBY_DUNGEON3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CeruleanCave1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CeruleanCave2F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map CeruleanCaveB1F, TILESET_CAVERN, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_RBY_DUNGEON1, TRUE, PALETTE_NITE, FISHGROUP_SHORE
