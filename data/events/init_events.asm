InitialEvents:
	...
	dw EVENT_BLUES_HOUSE_DAISY_WALKING
	dw EVENT_PALLET_TOWN_PROF_OAK
	dw EVENT_VIRIDIAN_CITY_OLD_MAN_AWAKE
	dw EVENT_OAKS_LAB_OAK1
	dw EVENT_OAKS_LAB_OAK2
	dw EVENT_ROUTE_22_RIVAL_1
	dw EVENT_ROUTE_22_RIVAL_2
	dw EVENT_CERULEAN_CITY_RIVAL
	dw EVENT_CERULEAN_CITY_GUARD1
	dw EVENT_BILLS_HOUSE_BILL1
	dw EVENT_BILLS_HOUSE_BILL2
	dw EVENT_SS_ANNE_2F_RIVAL
	dw EVENT_MR_FUJIS_HOUSE_MR_FUJI
	dw EVENT_ROCKET_HIDEOUT_B4F_SILPH_SCOPE
	dw EVENT_ROCKET_HIDEOUT_B4F_LIFT_KEY
	dw EVENT_SAFFRON_CITY_ROCKET_GROUP2
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_1B
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_2B
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_3B
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_4B
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_1C
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_2C
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_1D
	dw EVENT_SEAFOAM_ISLANDS_BOULDER_2D
	dw EVENT_CHAMPIONS_ROOM_PROF_OAK
	dw EVENT_VICTORY_ROAD_BOULDER_1B
