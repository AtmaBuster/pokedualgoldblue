...
; wViridianCitySceneID
	const_def
	const SCENE_VIRIDIAN_CITY_OLD_MAN  ; 0
	const SCENE_VIRIDIAN_CITY_GYM_LOCK ; 1
	const SCENE_VIRIDIAN_CITY_NOTHING  ; 2

; wOaksLabSceneID
	const_def 1
	const SCENE_OAKS_LAB_INTRO_START  ; 1
	const SCENE_OAKS_LAB_CANT_LEAVE   ; 2
	const SCENE_OAKS_LAB_RIVAL_BATTLE ; 3
...
; wVermilionDockSceneID
	const_def 1
	const SCENE_VERMILION_DOCK_SS_ANNE_LEAVING ; 1

; wRoute23SceneID
	const_def
	const SCENE_ROUTE_23_CASCADEBADGE ; 0
	const SCENE_ROUTE_23_THUNDERBADGE ; 1
	const SCENE_ROUTE_23_RAINBOWBADGE ; 2
	const SCENE_ROUTE_23_SOULBADGE    ; 3
	const SCENE_ROUTE_23_MARSHBADGE   ; 4
