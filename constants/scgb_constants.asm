...
PREDEFPAL_TOWN_MAP EQU PREDEFPAL_NITE
PREDEFPAL_RB_MEWMON EQU PREDEFPAL_DIPLOMA
PREDEFPAL_RB_BLUEMON EQU PREDEFPAL_TRADE_TUBE
PREDEFPAL_RB_REDMON EQU PREDEFPAL_POKEDEX
PREDEFPAL_RB_GRAYMON EQU PREDEFPAL_CGB_BADGE
PREDEFPAL_BETA_SHINY_GRAYMON EQU PREDEFPAL_PARTY_ICON
