...
; Kanto story events
	...
	const EVENT_GOT_NUGGET_BRIDGE_REWARD
	const EVENT_BILL_ENTERED_TELEPORTER
	const EVENT_HELPED_BILL
	const EVENT_GOT_SS_TICKET
	const EVENT_LEFT_BILLS_HOUSE_AFTER_HELPING
	const EVENT_GAVE_DRINK_TO_SAFFRON_GUARD
	const EVENT_BEAT_ROUTE_12_SNORLAX
	const EVENT_GOT_ITEMFINDER_KANTO
	const EVENT_GOT_TM_SWIFT
	const EVENT_GOT_EXP_SHARE
	const EVENT_GOT_OLD_ROD_KANTO
	const EVENT_GOT_SUPER_ROD_KANTO
	const EVENT_GOT_HM02_FLY_KANTO
	const EVENT_VERMILION_CITY_PASSED_TICKET_CHECK
	const EVENT_SS_ANNE_LEFT
	const EVENT_GOT_HM01_CUT_KANTO
	const EVENT_RESCUED_MR_FUJI
	const EVENT_GOT_POKEFLUTE
	const EVENT_GOT_TM_SOFTBOILED
	const EVENT_GOT_COIN_CASE
	const EVENT_GOT_TM_COUNTER
	const EVENT_GOT_TM_ICE_BEAM
	const EVENT_GOT_TM_ROCK_SLIDE
	const EVENT_GOT_TM_TRI_ATTACK
	const EVENT_GOT_TM_MEGA_DRAIN
	const EVENT_GAME_CORNER_GOT_10_COINS_FROM_MAN
	const EVENT_GAME_CORNER_GOT_20_COINS_FROM_MAN1
	const EVENT_GAME_CORNER_GOT_20_COINS_FROM_MAN2
	const EVENT_GAME_CORNER_OPENED_STAIRS
	const EVENT_ROCKET_HIDEOUT_B4F_DROPPED_KEY
	const EVENT_GOT_TM_PSYWAVE
	...
	const EVENT_SILPH_CO_11F_GOT_MASTER_BALL
	const EVENT_COPYCATS_HOUSE_2F_GOT_TM_MIMIC
	const EVENT_GOT_MON_FROM_FIGHTINIG_DOJO
	...
	const EVENT_CINNABAR_GYM_DOOR1
	const EVENT_CINNABAR_GYM_DOOR2
	const EVENT_CINNABAR_GYM_DOOR3
	const EVENT_CINNABAR_GYM_DOOR4
	const EVENT_CINNABAR_GYM_DOOR5
	const EVENT_CINNABAR_GYM_DOOR6
	const EVENT_GOT_TM_FIRE_BLAST
	const EVENT_CINNABAR_LAB_GAVE_DOME_FOSSIL
	const EVENT_CINNABAR_LAB_GAVE_HELIX_FOSSIL
	const EVENT_CINNABAR_LAB_GAVE_OLD_AMBER
	const EVENT_CINNABAR_LAB_IN_FOSSIL_ROOM
	const EVENT_GOT_TM_METRONOME
	const EVENT_POKEMON_MANSION_DOORS
	const EVENT_BOUGHT_MAGIKARP
	const EVENT_LORELEIS_ROOM_EXIT_OPEN
	const EVENT_BRUNOS_ROOM_KANTO_EXIT_OPEN
	const EVENT_AGATHAS_ROOM_EXIT_OPEN
	const EVENT_LANCES_ROOM_KANTO_ENTRANCE_CLOSED
	const EVENT_BEAT_CHAMPION_GEN1
	const EVENT_BEAT_LEAGUE
	const EVENT_VICTORY_ROAD_1F_STONE_ON_BUTTON
	const EVENT_VICTORY_ROAD_2F_STONE_ON_BUTTON1
	const EVENT_VICTORY_ROAD_2F_STONE_ON_BUTTON2
	const EVENT_VICTORY_ROAD_3F_STONE_ON_BUTTON
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_PATH_HIDDEN_NUGGET
	const EVENT_UNDERGROUND_PATH_HIDDEN_ELIXER
	...
	const EVENT_GAME_CORNER_HIDDEN_10_COINS1
	const EVENT_GAME_CORNER_HIDDEN_10_COINS2
	const EVENT_GAME_CORNER_HIDDEN_20_COINS1
	const EVENT_GAME_CORNER_HIDDEN_10_COINS3
	const EVENT_GAME_CORNER_HIDDEN_10_COINS4
	const EVENT_GAME_CORNER_HIDDEN_20_COINS2
	const EVENT_GAME_CORNER_HIDDEN_10_COINS5
	const EVENT_GAME_CORNER_HIDDEN_10_COINS6
	const EVENT_GAME_CORNER_HIDDEN_10_COINS7
	const EVENT_GAME_CORNER_HIDDEN_40_COINS
	const EVENT_GAME_CORNER_HIDDEN_100_COINS
	const EVENT_GAME_CORNER_HIDDEN_10_COINS8
...
; Psychic / Gen 1
	const EVENT_BEAT_PSYCHIC_JOHAN_GEN1
	const EVENT_BEAT_PSYCHIC_TYRON_GEN1
	const EVENT_BEAT_PSYCHIC_CAMERON_GEN1
	const EVENT_BEAT_PSYCHIC_PRESTON_GEN1
; Rocker / Gen 1
...
; Kanto people
	...
	const EVENT_MT_MOON_B2F_DOME_FOSSIL
	const EVENT_MT_MOON_B2F_HELIX_FOSSIL
	const EVENT_CERULEAN_CITY_RIVAL
	const EVENT_CERULEAN_CITY_ROCKET
	const EVENT_CERULEAN_CITY_GUARD1
	const EVENT_CERULEAN_CITY_SUPER_NERD
	const EVENT_CERULEAN_CITY_GUARD2
	const EVENT_ROUTE_24_ROCKET
	const EVENT_BILLS_HOUSE_MONSTER
	...
	const EVENT_POWER_PLANT_ELECTRODE1
	const EVENT_POWER_PLANT_VOLTORB4
	const EVENT_POWER_PLANT_VOLTORB5
	const EVENT_POWER_PLANT_ELECTRODE2
	...
	const EVENT_POKEMON_TOWER_7F_ROCKET1
	const EVENT_POKEMON_TOWER_7F_ROCKET2
	const EVENT_POKEMON_TOWER_7F_ROCKET3
	const EVENT_POKEMON_TOWER_7F_MR_FUJI
	const EVENT_CELADON_MANSION_ROOF_HOUSE_EEVEE
	const EVENT_GAME_CORNER_ROCKET
	...
	const EVENT_FIGHTING_DOJO_BALL1
	const EVENT_FIGHTING_DOJO_BALL2
	const EVENT_SEAFOAM_ISLANDS_B4F_ARTICUNO
	const EVENT_CHAMPIONS_ROOM_PROF_OAK
	const EVENT_VICTORY_ROAD_2F_MOLTRES
; Kanto itemballs
	...
	const EVENT_SEAFOAM_ISLANDS_BOULDER_1A
	const EVENT_SEAFOAM_ISLANDS_BOULDER_2A
	const EVENT_SEAFOAM_ISLANDS_BOULDER_3A
	const EVENT_SEAFOAM_ISLANDS_BOULDER_4A
	const EVENT_SEAFOAM_ISLANDS_BOULDER_1B
	const EVENT_SEAFOAM_ISLANDS_BOULDER_2B
	const EVENT_SEAFOAM_ISLANDS_BOULDER_3B
	const EVENT_SEAFOAM_ISLANDS_BOULDER_4B
	const EVENT_SEAFOAM_ISLANDS_BOULDER_1C
	const EVENT_SEAFOAM_ISLANDS_BOULDER_2C
	const EVENT_SEAFOAM_ISLANDS_BOULDER_1D
	const EVENT_SEAFOAM_ISLANDS_BOULDER_2D
	const EVENT_VICTORY_ROAD_BOULDER_1A
	const EVENT_VICTORY_ROAD_BOULDER_1B
...
; Unused: next 106 events
	...
	const_next 2176
NUM_EVENTS EQU const_value ; 880
