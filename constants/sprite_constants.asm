...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_KANTO_BLUE ; 60
	const SPRITE_KANTO_YOUNGSTER ; 61
	const SPRITE_LITTLE_GIRL ; 62
	const SPRITE_KANTO_BIRD ; 63
	const SPRITE_GAMBLER ; 64
	const SPRITE_KANTO_SUPER_NERD ; 65
	const SPRITE_GIRL ; 66
	const SPRITE_HIKER ; 67
	const SPRITE_KANTO_BEAUTY ; 68
	const SPRITE_KANTO_SAILOR ; 69
	const SPRITE_COOK ; 6a
	const SPRITE_BIKE_SHOP_CLERK ; 6b
	const SPRITE_GIOVANNI ; 6c
	const SPRITE_KANTO_ROCKET ; 6d
	const SPRITE_CHANNELER ; 6e
	const SPRITE_WAITER ; 6f
	const SPRITE_KANTO_ERIKA ; 70
	const SPRITE_BRUNETTE_GIRL ; 71
	const SPRITE_KANTO_SCIENTIST ; 72
	const SPRITE_KANTO_ROCKER ; 73
	const SPRITE_SAFARI_ZONE_WORKER ; 74
	const SPRITE_KANTO_GYM_GUIDE ; 75
	const SPRITE_KANTO_GRAMPS ; 76
	const SPRITE_KANTO_CLERK ; 77
	const SPRITE_KANTO_GRANNY ; 78
	const SPRITE_KANTO_NURSE ; 79
	const SPRITE_SILPH_PRESIDENT ; 7a
	const SPRITE_SILPH_WORKER ; 7b
	const SPRITE_WARDEN ; 7c
	const SPRITE_KANTO_KOGA ; 7d
	const SPRITE_GUARD ; 7e
	const SPRITE_KANTO_MOM ; 7f
	const SPRITE_BALDING_GUY ; 80
	const SPRITE_LITTLE_BOY ; 81
	const SPRITE_AGATHA ; 82
	const SPRITE_LORELEI ; 83
	const SPRITE_SEEL ; 84
	const SPRITE_FOSSIL ; 85
	const SPRITE_KANTO_BOULDER ; 86
	const SPRITE_CLIPBOARD ; 87
	const SPRITE_KANTO_SNORLAX ; 88
...
SPRITE_POKEMON EQU const_value
	...
	const SPRITE_GEODUDE ; a1
	const SPRITE_GROWLITHE ; a2
	const SPRITE_WEEDLE ; a3
	const SPRITE_SHELLDER ; a4
	const SPRITE_ODDISH ; a5
	const SPRITE_GENGAR ; a6
	const SPRITE_ZUBAT ; a7
	const SPRITE_MAGIKARP ; a8
	const SPRITE_SQUIRTLE ; a9
	const SPRITE_TOGEPI ; aa
	const SPRITE_BUTTERFREE ; ab
	const SPRITE_DIGLETT ; ac
	const SPRITE_POLIWAG ; ad
	const SPRITE_PIKACHU ; ae
	const SPRITE_CLEFAIRY ; af
	const SPRITE_CHARMANDER ; b0
	const SPRITE_JYNX ; b1
	const SPRITE_STARMIE ; b2
	const SPRITE_BULBASAUR ; b3
	const SPRITE_JIGGLYPUFF ; b4
	const SPRITE_GRIMER ; b5
	const SPRITE_EKANS ; b6
	const SPRITE_PARAS ; b7
	const SPRITE_TENTACOOL ; b8
	const SPRITE_TAUROS ; b9
	const SPRITE_MACHOP ; ba
	const SPRITE_VOLTORB ; bb
	const SPRITE_LAPRAS ; bc
	const SPRITE_RHYDON ; bd
	const SPRITE_MOLTRES ; be
	const SPRITE_SNORLAX ; bf
	const SPRITE_GYARADOS ; c0
	const SPRITE_LUGIA ; c1
	const SPRITE_HO_OH ; c2
