...
; FishGroups indexes (see data/wild/fish.asm)
	...
	const FISHGROUP_KANTO_DEFAULT
	const FISHGROUP_KANTO_1
	const FISHGROUP_KANTO_2
	const FISHGROUP_KANTO_3
	const FISHGROUP_KANTO_4
	const FISHGROUP_KANTO_5
	const FISHGROUP_KANTO_6
	const FISHGROUP_KANTO_7
	const FISHGROUP_KANTO_8
	const FISHGROUP_KANTO_9
	const FISHGROUP_KANTO_10
